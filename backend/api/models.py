...
def save_user_profile(sender, instance, **kwargs):#signal handlers
    instance.profile.save()

post_save.connect(create_user_profile, sender=User) #post_save allows you to execute some code immediately after a model’s save method is called.
